...
if (isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in'] === true) {
    ...
    exit;
} elseif (isset($_SESSION['pharmacist_logged_in']) && $_SESSION['pharmacist_logged_in'] === true) {
    header("Location: select_dashboard.php");
    exit;
}
            ...
            if (mysqli_num_rows($result) == 1) {
                ...
                if ($password == $user['password']) { // Temporary plain text comparison
                    ...
                    if ($user['role'] == 'admin') {
                        ...
                        $_SESSION['pharmacist_logged_in'] = true;  // Give access to both
                    } elseif ($user['role'] == 'pharmacist') {
                        $_SESSION['pharmacist_logged_in'] = true;
                        $_SESSION['admin_logged_in'] = true;  // Give access to both
                    }
                    header("Location: select_dashboard.php");
                    exit;
                } else {
